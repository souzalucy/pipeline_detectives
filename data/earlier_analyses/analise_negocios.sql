--1. Qual a categoria que possui o produto com o maior número de dias entre a primeira compra da categoria e a sua data limite de entrega?
...
ORDER BY 
 ...
 --18. Qual o valor da soma de todos que estão acima da posição 5 do ranking de produtos mais caros da categoria brinquedos.
SELECT 
